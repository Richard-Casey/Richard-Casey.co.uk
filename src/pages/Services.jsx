...
function Services() {
  return (
    <>
      ...
      >
        <h1 className="text-3xl font-bold text-[var(--primary-blue-alt)] text-center mb-10">
          Services I Offer
        </h1>

        <div className="max-w-4xl mx-auto space-y-8 text-gray-300">
          <div>
            <h2 className="text-xl font-semibold text-white dark:text-white">🕸 Web Development</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-white dark:text-white">🎮 Game Prototypes</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-white dark:text-white">🛠 Workflow Tools</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-white dark:text-white">💡 Technical Consulting</h2>
            <p>
